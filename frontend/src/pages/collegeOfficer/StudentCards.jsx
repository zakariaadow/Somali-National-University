  ...
  const fetchCards = async () => {
    try {
      ...
      const [pendingRes, approvedRes, rejectedRes] = await Promise.all([
        axios.get(`${API_BASE_URL}/college-officer/student-cards/pending`, { withCredentials: true }),
        axios.get(`${API_BASE_URL}/college-officer/student-cards/approved`, { withCredentials: true }),
        axios.get(`${API_BASE_URL}/college-officer/student-cards/rejected`, { withCredentials: true })
      ]);
  ...
  const handleApprove = async (cardId) => {
    ...
    try {
      const response = await axios.post(
        `${API_BASE_URL}/college-officer/student-cards/review/${cardId}`,
        { status: 'approved' },
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">Review and approve student card applications</p>
            </div>
...
export default CollegeStudentCards;