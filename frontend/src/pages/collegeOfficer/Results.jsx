...
const CollegeResults = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        setLoading(true);
        const [resultsRes, semestersRes, yearsRes, facultiesRes, programmesRes, unitsRes] = await Promise.all([
          axios.get(`${API_BASE_URL}/college-officer/results`, { withCredentials: true }),
  ...
  const applyFilters = () => {
    const fetchFiltered = async () => {
      try {
        ...
        const response = await axios.get(`${API_BASE_URL}/college-officer/results?${params}`, {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          ...
          <p className="text-gray-600">View and manage student results across the college</p>
        </div>
