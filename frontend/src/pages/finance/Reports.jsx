...
const FinanceReports = () => {
  ...
  const reportTypes = [
    ...
    { value: 'exam-card', label: 'Exam Card Report' },
    { value: 'fee-structure', label: 'Fee Structure Report' },
        ...
        {reportData && (
          <div className="bg-white rounded-lg shadow-lg p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">
              {reportData.report_type || 'Financial Report Results'}
            </h2>
            ...
            {reportData.by_payment_method && (
              <div className="mt-4">
                <h3 className="font-semibold text-gray-900 mb-2">By Payment Method</h3>
